...
#     ddpm_beta0_file = os.path.join('/mnt/camca_NAS/denoising/models/unsupervised_gaussian_2D_current_beta0/pred_images', patient_id, patient_subid,'random_'+str(random_n), 'epoch61_1/pred_img.nii.gz')
...
#     ddpm_beta20_file = os.path.join('/mnt/camca_NAS/denoising/models/unsupervised_gaussian_2D_current_beta20/pred_images', patient_id, patient_subid,'random_'+str(random_n), 'epoch58_1/pred_img.nii.gz')
...
#     ddpm_beta0_avg_20_file = os.path.join('/mnt/camca_NAS/denoising/models/unsupervised_gaussian_2D_current_beta0/pred_images', patient_id, patient_subid,'random_'+str(random_n), 'epoch61avg/pred_img_scans20.nii.gz')
#     ddpm_beta0_avg_20_img = nb.load(ddpm_beta0_avg_20_file).get_fdata() if avg_slice == False else nb.load(ddpm_beta0_avg_20_file).get_fdata()[:,:,1:shape[2]-1]
#     ddpm_beta0_avg_20_img_brain = Data_processing.cutoff_intensity(ddpm_beta0_avg_20_img, cutoff_low=-100, cutoff_high=100)
...
#     ddpm_beta0_avg_20_img_brain_ROI = np.clip(ddpm_beta0_avg_20_img_brain[x-50: x+50, y-50: y+50, 20:40],0,100)
#     mean_gt, mean_condition, mean_n2n, mean_supervised, mean_ddpm, mean_ddpm_beta0, mean_ddpm_beta20, mean_ddpm_avg_10, mean_ddpm_avg_20, mean_ddpm_beta0_avg_20 = np.mean(gt_img_brain_ROI), np.mean(condition_img_brain_ROI), np.mean(noise2noise_img_brain_ROI), np.mean(supervised_img_brain_ROI), np.mean(ddpm_img_brain_ROI), np.mean(ddpm_beta0_img_brain_ROI), np.mean(ddpm_beta20_img_brain_ROI), np.mean(ddpm_avg_10_img_brain_ROI), np.mean(ddpm_avg_20_img_brain_ROI), np.mean(ddpm_beta0_avg_20_img_brain_ROI)
#     results_mean.append([patient_id, patient_subid, random_n, mean_gt, mean_condition, mean_n2n, mean_supervised, mean_ddpm, mean_ddpm_beta0, mean_ddpm_beta20, mean_ddpm_avg_10, mean_ddpm_avg_20, mean_ddpm_beta0_avg_20])
...
#     'mean_ddpm_avg_10', 'mean_ddpm_avg_20', 'mean_ddpm_beta0_avg_20'])
#     file_name_mean = 'mean_measurements_current.xlsx' 
...
#     mae_brain_ddpm_beta0_avg_20, _, rmse_brain_ddpm_beta0_avg_20, _, ssim_brain_ddpm_beta0_avg_20,psnr_brain_ddpm_beta0_avg_20 = ff.compare(ddpm_beta0_avg_20_img_brain[mask_eroded==1], gt_img_brain[mask_eroded==1], cutoff_low = 0, cutoff_high = 100)
...
#     print('ddpm_beta0_avg_20:', mae_brain_ddpm_beta0_avg_20, rmse_brain_ddpm_beta0_avg_20, ssim_brain_ddpm_beta0_avg_20, psnr_brain_ddpm_beta0_avg_20)
...
#     lpips_brain_ddpm_beta0_avg_20 = compute_lpips_3d(ddpm_beta0_avg_20_img_brain, gt_img_brain, max_val = 100, min_val = 0, mask = mask_eroded)
...
#     print('ddpm_beta0_avg_20:', lpips_brain_ddpm_beta0_avg_20)
...
#     mae_brain_ddpm_beta0_avg_20, rmse_brain_ddpm_beta0_avg_20, ssim_brain_ddpm_beta0_avg_20, psnr_brain_ddpm_beta0_avg_20,
#     lpips_brain_motion, lpips_brain_n2n, lpips_brain_supervised, lpips_brain_ddpm, lpips_brain_ddpm_beta0,lpips_brain_ddpm_beta20, lpips_brain_ddpm_avg_10, lpips_brain_ddpm_avg_20, lpips_brain_ddpm_beta0_avg_20])
...
#     'mae_brain_ddpm_avg_20', 'rmse_brain_ddpm_avg_20', 'ssim_brain_ddpm_avg_20', 'psnr_brain_ddpm_avg_20',
#     'mae_brain_ddpm_beta0_avg_20', 'rmse_brain_ddpm_beta0_avg_20', 'ssim_brain_ddpm_beta0_avg_20', 'psnr_brain_ddpm_beta0_avg_20',
#     'lpips_brain_motion', 'lpips_brain_n2n', 'lpips_brain_supervised', 'lpips_brain_ddpm', 'lpips_brain_ddpm_beta0','lpips_brain_ddpm_beta20' ,
#     'lpips_brain_ddpm_avg_10', 'lpips_brain_ddpm_avg_20', 'lpips_brain_ddpm_beta0_avg_20'])
#     file_name = 'quantitative_results_current.xlsx' if avg_slice == False else 'quantitative_results_avg_slice.xlsx'
...
for i in range(0,n.shape[0]):
    ...
    gt_file = os.path.join('/mnt/camca_NAS/denoising/models/unsupervised_gaussian_2D_current_beta0/pred_images', patient_id, patient_subid,'random_'+str(random_n), 'epoch61_1/gt_img.nii.gz')
    gt_img = nb.load(gt_file).get_fdata()
    # process gt
    shape = gt_img.shape
    ...
    ddpm_avg_files = ff.sort_timeframe(ff.find_all_target_files(['pred_img_scans*'], os.path.join('/mnt/camca_NAS/denoising/models/unsupervised_gaussian_2D_current_beta0/pred_images', patient_id, patient_subid,'random_'+str(random_n), 'epoch61avg')),2,'s','.')
