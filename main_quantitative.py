...
for i in range(0,5):
    ...
    file_name_mean = 'mean_measurements_current_first5.xlsx' 
    ...
    'lpips_brain_ddpm_avg_10', 'lpips_brain_ddpm_avg_20'])
    file_name = 'quantitative_results_current_first5.xlsx' if avg_slice == False else 'quantitative_results_avg_slice.xlsx'
