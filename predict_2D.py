...
for i in range(0,1):#x0_list.shape[0]):
    ...
    affine = gt_img.affine; gt_img = gt_img.get_fdata()[:,:,50:55]

    # get the condition image
    condition_img = nb.load(condition_file).get_fdata()[:,:,50:55]
